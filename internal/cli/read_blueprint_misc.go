...
func runBlueprint(args []string, stdout, stderr io.Writer) int {
	return dispatchSubcommand(
		...
		stdout,
		stderr,
		"usage: bpx blueprint <info|anim-info|bytecode|disasm|trace|call-args|refs|search|scan-functions|infer-pack> ...",
		"unknown blueprint command: %s\n",
		subcommandSpec{Name: "info", Run: runBlueprintInfo},
		subcommandSpec{Name: "anim-info", Run: runBlueprintAnimInfo},
